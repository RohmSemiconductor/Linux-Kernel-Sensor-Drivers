...
{%- if page.upstreamlink %} Driver is included in the [Upstream Linux]({{ page.upstreamlink }}) from {{ page.upstreamed }} onwards.

{%- else %} Driver is included in the Upstream Linux from {{ page.upstreamed }} onwards.
