...
KX022ACR-Z is a 3-axis accelerometer from ROHM/Kionix&trade;. The sensor features include variable ODRs, I2C and SPI control, FIFO/LIFO with watermark IRQ, tap/motion detection, wake-up & back-to-sleep events, four acceleration ranges (&plusmn;2, &plusmn;4, &plusmn;8 and &plusmn;16 g), etc.
